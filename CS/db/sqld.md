...
* 로그를 남기는 것을 원칙으로 하며 테이블을 삭제하면 DELETE FROM이 맞다

* Truncate 는 완전 초기화 => Rollcack 불가
...
* NULL이 한번이라도 있으면 NULL로 출력됨

### 36번 문제

* NULL이 아닌 경우를 찾아내는 문장은 IS NOT NULL
